...
class theseencode(QDialog, QMainWindow):
    def __init__(self):
        ...
        self.Reset_GUI()
        self.Print.clicked.connect(p1)
        self.Reset.clicked.connect(p1)
        self.Genbill.clicked.connect(p1)
        # self.textEdit.setText.connect(p1)

        self.Data=xlrd.open_workbook('ItemsDetails.xlsm')
